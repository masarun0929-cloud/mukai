# むかいせな歌唱データベース 公開セットアップ

この手順は、むかいせな歌唱データベースを GitHub + Cloudflare Pages + Cloudflare D1 で公開するためのものです。
...
```text
Token name: mukai-sena-actions-dispatch
