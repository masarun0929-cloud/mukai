...
function buildDataset(channel, tables, originalKeywords, generatedAt = '') {
...
export async function onRequestGet({ env }) {
  try {
    ...
    for (const channel of channels) {
      channelDatasets[channel.code] = buildDataset(channel, tables, genreKeywords, generatedAt);
    }
    const liveData = buildLives(tables);
    return json({
      generatedAt,
      channels: channelDatasets,
      combined: mergeChannels(Object.values(channelDatasets), generatedAt),
